...
pub fn LinkRepositoryModal(
    ...
    view! {
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            <div class="bg-dt-card border border-slate-700/50 rounded-lg w-full max-w-xl mx-4 max-h-[80vh] flex flex-col">
                // Header
                ...
                <div class="p-4 border-t border-slate-700/50">
                    <button
                        class="w-full py-2 text-dt-text-sub hover:text-dt-text transition-colors"
                        on:click=move |_| on_close()
                    >
                        "Cancel"
                    </button>
