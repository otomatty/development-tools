        ...
        <div class="flex-1 p-6 overflow-y-auto">
            ...
            <Show when=move || show_create_modal.get()>
                <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
                    <div class="bg-dt-card border border-slate-700/50 rounded-lg p-6 w-full max-w-md mx-4">
                        <h2 class="text-xl font-semibold text-dt-text mb-4">"Create New Project"</h2>
                        
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-dt-text-sub mb-1">"Project Name"</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label class="block text-sm font-medium text-dt-text-sub mb-1">"Description (optional)"</label>
                                <textarea
